              ...
              <div>
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div
                      v-if="errorMessage"
                      class="p-3 rounded-lg bg-error-50 border border-error-200 dark:bg-error-950 dark:border-error-800"
                    >
        ...
        >
          ...
          <div class="flex justify-center mb-6">
            <div class="relative">
              ...
              >
                <svg
                  class="w-10 h-10 text-green-600 dark:text-green-400 animate-check-draw"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div class="text-center animate-fade-in-up">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-3">Welcome Back! 🎉</h2>
            ...
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4 overflow-hidden">
              <div class="bg-brand-500 h-full rounded-full animate-progress"></div>
            </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (result.success && result.data) {
      // Validate role for staff signin page
      if (result.data.user.role !== 'petugas') {
        errorMessage.value = 'Invalid credentials. Only staff users can login here.'
        // Clear stored data
