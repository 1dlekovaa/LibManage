        ...
        <div class="col-span-12 space-y-6">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">
                Manage all staff accounts in the system
              </p>
            </div>
            <button
          ...
          <div v-if="isLoading" class="flex items-center justify-center py-12">
            <div class="space-y-4 text-center">
              ...
              <p class="text-gray-500 dark:text-gray-400">Loading staff...</p>
            </div>
          </div>
        ...
        >
          ...
          <div class="px-6 py-4 space-y-4">
            ...
            <div>
              ...
              >
                <p class="font-medium">Petugas (Staff)</p>
              </div>
            </div>
      ...
      >
        ...
        >
          ...
          <div class="p-6 text-center border-b border-gray-200 dark:border-gray-700">
            ...
            <h3 class="text-lg font-bold text-gray-900 dark:text-white">Delete Staff</h3>
...
const filteredUsers = computed(() => {
  let filtered = users.value.filter((user) => user.role === 'petugas')
...
const loadUsers = async () => {
  ...
  try {
    ...
    if (result.success && result.data) {
      ...
      errorMessage.value = result.error?.message || 'Failed to load staff'
    }
  } catch (error) {
  ...
  try {
    ...
    if (modalMode.value === 'create') {
      ...
      if (result.success) {
        ...
        modalError.value = result.error?.message || 'Failed to create staff'
      }
    } else {
      // Edit mode
      if (editingUserId.value) {
        ...
        if (result.success) {
          ...
          modalError.value = result.error?.message || 'Failed to update staff'
        }
      }
    }
  } catch (error) {
...
const performDelete = async () => {
  ...
  try {
    ...
    if (result.success) {
      ...
      errorMessage.value = result.error?.message || 'Failed to delete staff'
    }
  } catch (error) {
    errorMessage.value = 'An unexpected error occurred'
